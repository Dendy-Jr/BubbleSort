package com.olehvynnytskyi.bubblesort.domain.use_case

import com.olehvynnytskyi.bubblesort.domain.model.SortInfo
...
@Singleton
class BubbleSortUseCase @Inject constructor() {
